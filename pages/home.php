<section class="banner-container">
	...
	<section class="descricao-autor">
		<div class="center">
			...
			<div class="w50 left">
				<img class="right" src="<?php echo INCLUDE_PATH; ?>images/jessica.jpg">
			</div> <!-- w50 -->
			<div class="clear"></div>
	...
	<section id="servicos" class="extras">
		...
		<div class="center">
			...
			<div class="w50 left servicos-container">
				...
				<ul>
					<li>Mussum Ipsum, cacilds vidis litro abertis. Delegadis gente finis, bibendum egestas augue arcu ut est. Tá deprimidis, eu conheço uma cachacis que pode alegrar sua vidis. Praesent vel viverra nisi. Mauris aliquet nunc non turpis scelerisque, eget. Aenean aliquam molestie leo, vitae iaculis nisl. 
					</li>
